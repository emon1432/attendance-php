...
if (isset($_POST['save'])) {
  ...
  if ($ret > 0) {
    ...
    $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>This Session and Semester Already Exists!</div>";
  } else {
                ...
                <div class="col-lg-12">
                  <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      ...
                      <h6 class="m-0 font-weight-bold text-danger">Note: <i>Click on the check symbol besides each to make session and semester active!</i></h6>
                    </div>
