...
if (isset($_POST['save'])) {
  ...
  if ($ret > 0) {
  ...
  } elseif ($password1 != $Pass) {

    $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>Password Mismatch!</div>";
  } else {
    ...
    value('$firstName','$lastName','$emailAddress','$encryptPass','$phoneNo','$classId','$classArmId','$dateCreated')");
                  ...
                  <form method="post">
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-xl-6">
                        ...
                        <input type="password" class="form-control" required name="confirmPassword" value="<?php echo $row['confirmPassword']; ?>" id="exampleInputFirstName">
                      </div>
                    </div>
