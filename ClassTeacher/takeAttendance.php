...
<head>
  ...
  <link href="img/logo/IST_LOGO.png" rel="icon">
                  ...
                  <div class="col-lg-12">
                    <div class="card mb-4">
                      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">All Student in (<?php echo $rrw['className'] . ' - ' . $rrw['classArmName']; ?>) Department</h6>
                      ...
                      <div class="table-responsive p-3">
                        ...
                        <table class="table align-items-center table-flush table-hover">
                          ...
                          <tbody>
                            ...
                            <?php
                            $query = "SELECT distinct tblstudents.Id,
                            ...
                            FROM tblstudents,tblclassteacher,tblclassarms,tblclass
                            WHERE tblstudents.classId = tblclass.id
                            AND tblclassteacher.classId = tblstudents.classId
                            AND tblclassarms.Id = $_SESSION[classArmId]";
                            $rs = $conn->query($query);
                            $num = $rs->num_rows;
                            $sn = 0;
                            $status = "";
